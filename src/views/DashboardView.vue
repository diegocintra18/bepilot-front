...
const navItems = [
  ...
  { label: 'Meus Cursos', icon: 'book', active: false },
  { label: 'Simulados', icon: 'timer', active: false },
  { label: 'Performance', icon: 'trending-up', active: false },
...
<template>
  <div class="min-h-screen bg-background text-on-background antialiased md:flex">
    ...
    >
      ...
      <nav class="flex-1 overflow-y-auto" aria-label="Navegação do dashboard">
        <a
    ...
    <main class="flex h-screen flex-1 flex-col md:ml-64">
      ...
      >
        <div class="flex items-center gap-4">
          ...
          <h1 class="font-headline-md text-headline-md font-bold text-primary">Dashboard do Estudante</h1>
        </div>
      ...
      <div class="flex-1 overflow-y-auto p-margin-mobile md:p-12">
        <div class="mx-auto w-full max-w-container-max-width space-y-stack-lg">
          <section
